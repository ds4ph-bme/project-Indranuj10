...
see redundancy in feature space(entire analysis is there in the python notebook:Housing__Prediciton). Later I tried combination of features based on their significance with ramdon forest as a regressor and finally got least RMSE for 9 features ,hence reducing the feature space from 13 to 9. 
